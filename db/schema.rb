...
ActiveRecord::Schema.define(version: 2023_01_10_075852) do
  ...
  create_table "post_learning_tags", force: :cascade do |t|
    t.integer "post_learning_id", null: false
    t.integer "tag_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["post_learning_id"], name: "index_post_learning_tags_on_post_learning_id"
    t.index ["tag_id"], name: "index_post_learning_tags_on_tag_id"
  end
