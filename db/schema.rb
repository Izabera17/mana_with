...
ActiveRecord::Schema.define(version: 2023_01_18_081539) do
  ...
  create_table "favorites", force: :cascade do |t|
    ...
    t.index ["post_learning_id"], name: "index_favorites_on_post_learning_id"
  ...
  create_table "notifications", force: :cascade do |t|
    ...
    t.index ["post_learning_id"], name: "index_notifications_on_post_learning_id"
  ...
  add_foreign_key "favorites", "post_learnings"
  add_foreign_key "favorites", "users"
  add_foreign_key "messages", "rooms"
  add_foreign_key "messages", "users"
  add_foreign_key "post_comments", "post_learnings"
